...
def render_policy(agent, total_episodes:int, device):
    ...
    with torch.no_grad():
        ...
        for episode in range(total_episodes):
            ...
            # Append the frame from the environment
            frames.append(env.render())

    # Save frames as a GIF
    output_filename = "INF8250AE_MARL_NOTEBOOK/PettingZoo_PistonBall/pistonball.gif"
